...
const plugin = {
  install: Vue => {
    ...
    Vue.prototype.$mediaBreakpointBetween = function(start, end) {
      if ((start, end)) {
        return (
          this.$root._bootstrap.width >= breakpoints[start] &&
          this.$root._bootstrap.width < breakpoints[end]
        );
      }
      return null;
    };
    ...
    Vue.prototype.$mediaBreakpointOnly = function(key) {
      if (key === "xs") {
        ...
        return (
          this.$root._bootstrap.width >= breakpoints.sm &&
          this.$root._bootstrap.width < breakpoints.md - edge
        );
      } else if (key === "md") {
        return (
          this.$root._bootstrap.width >= breakpoints.md &&
          this.$root._bootstrap.width < breakpoints.lg - edge
        );
      } else if (key === "lg") {
        return (
          this.$root._bootstrap.width >= breakpoints.lg &&
          this.$root._bootstrap.width < breakpoints.xl - edge
        );
      } else if (key === "xl") {
        return (
          this.$root._bootstrap.width >= breakpoints.xl &&
          this.$root._bootstrap.width < breakpoints.xxl - edge
        );
      } else if (key === "xxl") {
        return this.$root._bootstrap.width >= breakpoints.xxl;
      }
      return null;
    };
  }
